...
mask=(branches["met_Et"] > 200) & (branches["nLep_signal"] == 2) & (branches["lep1Flavor"] == branches["lep2Flavor"]) & (branches["lep1Charge"] == -1*branches["lep2Charge"]) & (branches["nLep_base"] == 2) & (branches["met_Et"]/branches["METOverJ1pT"] > 100) & (branches["DPhiJ1Met"] > 2.0) & (branches["nJet30"] < 3) & (branches["nJet30"] > 0) & (branches["minDPhiAllJetsMet"] > 0.4) & (branches["nBJet20"] == 0) & (branches["lep1Pt"] > 10) & (branches["lep2Pt"] > 10) & (branches["Rll"] > 0.75) & (branches["mt_lep1"] > 10) & (branches["mt_lep2"] > 10)

branches_to_keep=[
    'lep1Flavor','lep1Charge','lep1Pt','lep1Eta','lep1Phi','lep1MT_Met','lep1_DPhiMet','lep1Signal','mt_lep1',
    'lep2Flavor','lep2Charge','lep2Pt','lep2Eta','lep2Phi','lep2MT_Met','lep2_DPhiMet','lep2Signal','mt_lep2',
    'Rll','Ptll',
    'nJet30','nBJet30',
    'jetPt','jetEta','jetPhi','jetBtagged',
    'met_Et','met_Phi',
...
with h5py.File(infile.replace(".root","__"+intree+".hf5"), "w") as hdf5file:
    ...
    data=hdf5file.create_dataset(intree,
                                 (n_events_after_mask,),
                                 dtype=dt,
                                )
    for bname in branches[0].tolist().keys():
